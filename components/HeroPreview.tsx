...
export function HeroPreview() {
  ...
  return (
    <Link
      href={`/e/${item.id}`}
      className="group relative block overflow-hidden rounded-2xl border border-paper-line bg-surface transition-shadow hover:shadow-[0_4px_20px_rgba(27,27,27,0.10)]"
