...
export function HeroPreview() {
  ...
  return (
    <Link
      href={`/e/${item.id}`}
      className="group relative block overflow-hidden rounded-2xl border border-paper-line bg-white transition-shadow hover:shadow-[0_4px_20px_rgba(31,151,220,0.08)]"
    ...
    >
      ...
      <div
        key={`${item.id}-${replay}`}
        className="hero-anim panel-svg-wrap px-6 pb-4 pt-14 sm:px-10 sm:pt-16"
