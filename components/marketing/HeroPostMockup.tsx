...
const FALLBACK_PANEL = {
  ...
  source: "stripe.com",
  svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 680 480" role="img" font-family="ui-sans-serif, system-ui, -apple-system, Segoe UI, Helvetica, Arial, sans-serif"><title>Iceberg</title><desc>The 10 percent users see vs the 90 percent it took to build</desc><rect x="0" y="200" width="680" height="280" fill="#F9E5D9" opacity="0.55"/><line x1="0" y1="200" x2="680" y2="200" stroke="#B23F14" stroke-width="1" opacity="0.4"/><line x1="0" y1="208" x2="680" y2="208" stroke="#B23F14" stroke-width="1" opacity="0.18"/><path d="M 300 200 L 330 108 L 366 156 L 396 200 Z" fill="#ffffff" stroke="#B23F14" stroke-width="1.5"/><path d="M 272 200 L 232 252 L 218 322 L 240 400 L 312 432 L 396 422 L 444 380 L 458 290 L 430 220 L 410 200 Z" fill="#ffffff" stroke="#B23F14" stroke-width="1.5" opacity="0.92"/><text x="338" y="316" font-size="56" font-weight="500" fill="#B23F14" text-anchor="middle" opacity="0.18">90%</text><line x1="384" y1="135" x2="490" y2="105" stroke="#6B6B6B" stroke-width="1"/><circle cx="384" cy="135" r="2.5" fill="#6B6B6B"/><text x="500" y="100" font-size="14" font-weight="500" fill="#8F3210">The 10% users see</text><text x="500" y="118" font-size="12" fill="#3a3a3a">Polished UI, the demo,</text><text x="500" y="134" font-size="12" fill="#3a3a3a">the launch tweet</text><line x1="290" y1="340" x2="160" y2="380" stroke="#6B6B6B" stroke-width="1"/><circle cx="290" cy="340" r="2.5" fill="#6B6B6B"/><text x="40" y="376" font-size="14" font-weight="500" fill="#8F3210">The 90% that built it</text><text x="40" y="394" font-size="12" fill="#3a3a3a">Research, infra, ten</text><text x="40" y="410" font-size="12" fill="#3a3a3a">attempts that didn't ship</text></svg>`,
};
