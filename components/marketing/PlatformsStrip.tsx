          ...
          <div className="grid items-baseline gap-8 sm:grid-cols-[180px_1fr]">
            ...
            <ul className="flex flex-wrap items-center gap-2.5">
              {PLATFORMS.map((p) => (
                <li
                  key={p.name}
                  className="flex cursor-default items-baseline gap-2 rounded-full border border-paper-line bg-surface px-3.5 py-1.5 transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/50 hover:shadow-[0_8px_20px_-12px_rgba(27,27,27,0.25)]"
                >
